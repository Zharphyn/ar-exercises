...
pp "Please enter the name of the new store that you would like to create:"
@new_store = gets.chomp
@create_new_store = Store.create(name: @new_store )
@create_new_store.valid? 
pp "Errors for #{@new_store} are:"
@create_new_store.errors.full_messages.each { |m| pp m }
